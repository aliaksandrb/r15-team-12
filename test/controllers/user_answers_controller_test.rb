...
class UserAnswersControllerTest < ActionController::TestCase
  ...
  test "should create user_answer" do
    assert_difference('UserAnswer.count') do
      post :create, user_answer: { game_id: @user_answer.game_id, question_id: @user_answer.question_id, timeout: @user_answer.timeout, value: @user_answer.value }
    end
  ...
  test "should update user_answer" do
    patch :update, id: @user_answer, user_answer: { game_id: @user_answer.game_id, question_id: @user_answer.question_id, timeout: @user_answer.timeout, value: @user_answer.value }
    assert_redirected_to user_answer_path(assigns(:user_answer))
  end
